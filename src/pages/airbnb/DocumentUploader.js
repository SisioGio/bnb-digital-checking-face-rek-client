  ...
  return (
    ...
    >
     ...
     <p className="mb-6 text-gray-700 text-center">
        {/* in italian */}
        Per completare il checkin, è necessario caricare i documenti richiesti.
        <br />
...
<p className=" text-gray-500 text-center text-xs">
  I tuoi documenti verranno utilizzati esclusivamente per le procedure di check-in e trasmessi alle autorità tramite il portale Alloggiati Web, in conformità con la normativa vigente.
<br />
  Cliccando su <strong>Invia Documenti</strong>, confermi di aver letto e compreso l’informativa sulla gestione dei dati personali e acconsenti al loro utilizzo per le procedure di check-in.
</p>
    </motion.div>
  );
};
