...
const IdentityVerification = ({
  ...
  return (
    ...
    >
      <h2 className="text-2xl font-bold text-center text-gray-800">Verifica dell'identità</h2>
      ...
      <div>
        ...
        <label className="cursor-pointer flex items-center gap-3 bg-gray-50 border border-gray-200 p-4 rounded-xl hover:bg-gray-100 transition">
          ...
          <span className="text-sm text-gray-600">Clicca per scattare una foto</span>
          <input
            type="file"
            accept="image/*"
            capture="environment"
      ...
      <p className="text-sm text-gray-500">
        Assicurati di essere in un luogo ben illuminato e che il tuo volto sia chiaramente visibile.
        </p>
      ...
      >
       ...
       La tua foto verrà utilizzata per verificare la tua identità e confrontata con i documenti caricati. 
       Assicurati che il tuo volto sia chiaramente visibile e che non ci siano ostruzioni.
       La tua foto non sarà condivisa con terze parti.
       <br/>
       Per qualsiasi problema o domanda, contatta il proprietario della struttura.
